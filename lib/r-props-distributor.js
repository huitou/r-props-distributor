...
const PropsDistributors = props => {
  ...
  return React__default.createElement(PropsContext.Provider, {
...
const HoistDistributor = props => {
  ...
  return React__default.createElement(HoistContext.Provider, {
    value: hoistHandles
  }, children);
};

class HoistManager extends React__default.Component {
  constructor(props) {
  ...
  render() {
    ...
    return React__default.createElement(HoistDistributor, {
      hoistName: hoistName,
      hoistHandles: this.hoistHandles
    }, React__default.createElement(PropsDistributors, {
      hoistName: hoistName,
...
const propsHoist = (hoistName = rootHoistName) => WrappedComponent => props => React__default.createElement(HoistManager, {
  hoistName: hoistName
...
const hoistRegister = (hoistName = rootHoistName) => WrappedComponent => props => {
  ...
  if (HoistContext) {
    return React__default.createElement(HoistContext.Consumer, null, contextProps => React__default.createElement(WrappedComponent, _extends({}, contextProps, props)));
  } else {
...
class PropsRegister extends React__default.Component {
  componentDidMount() {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (!ramda.equals(propsValue, prevProps.propsValue)) {
...
class HoistingPropsRegisterHolder extends React__default.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return React__default.createElement(HoistingPropsRegister, {
      propsName: propsName,
...
const PropsCollect = (propsName, mapper = unitMapper, hoistName = rootHoistName) => WrappedComponent => props => React__default.createElement(HoistingPropsRegisterHolder, {
  hoistName: hoistName,
  propsName: propsName,
...
const propsConnect = (propsName, mapper = unitMapper, hoistName = rootHoistName) => WrappedComponent => props => {
  ...
  if (PropsContext) {
    return React__default.createElement(PropsContext.Consumer, null, contextProps => React__default.createElement(WrappedComponent, _extends({}, mapper(contextProps[propsName]), props)));
  } else {
...
exports.PropsCollect = PropsCollect;
exports.propsConnect = propsConnect;
exports.propsHoist = propsHoist;
